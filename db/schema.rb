...
ActiveRecord::Schema.define(version: 20_211_201_141_137) do
  ...
  create_table 'category_lists', force: :cascade do |t|
    ...
    t.index %w[categoriable_type categoriable_id], name: 'index_category_lists_on_categoriable'
  ...
  create_table 'payment_methods', force: :cascade do |t|
    ...
    t.index %w[user_id payment_type], name: 'index_payment_methods_on_user_id_and_payment_type', unique: true
  ...
  create_table 'product_receipts', force: :cascade do |t|
    ...
    t.index %w[product_type product_id], name: 'index_product_receipts_on_product'
  ...
  create_table 'subscription_plan_values', force: :cascade do |t|
    ...
    t.index %w[subscription_plan_id end_date], name: 'by_plan_and_end_date', unique: true
    t.index %w[subscription_plan_id start_date], name: 'by_plan_and_start_date', unique: true
  ...
  create_table 'user_videos', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[user_id video_id], name: 'index_user_videos_on_user_id_and_video_id', unique: true
  ...
  create_table 'videos', force: :cascade do |t|
    ...
    t.decimal 'value'
    t.string 'token'
    t.index %w[streamer_id title], name: 'index_videos_on_streamer_id_and_title', unique: true
